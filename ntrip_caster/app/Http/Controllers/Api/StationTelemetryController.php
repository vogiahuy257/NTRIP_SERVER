...
{
    public function store(StoreStationTelemetryRequest $request, string $deviceId): JsonResponse
    {
        ...
        $stationToken = $request->header('X-Station-Token');
        ...
        broadcast(new StationTelemetryUpdated(
            station: $station,
            telemetry: $telemetry,
