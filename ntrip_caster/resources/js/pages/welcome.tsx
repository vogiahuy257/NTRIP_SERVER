            ...
            <div className="relative isolate min-h-screen overflow-x-clip bg-[#f7f7f3] text-[#11110f] selection:bg-black selection:text-white">
                ...
                <main className="relative z-10">
                    ...
                    <section
                        ...
                        className="relative scroll-mt-20 px-4 py-16 sm:px-6 sm:py-20 md:px-8 lg:h-[500svh] lg:px-0 lg:py-0"
                    >
                        {/* Mobile/tablet: cuộn tự nhiên để không làm giao diện quá chật. */}
                        <div className="mx-auto max-w-[1440px] lg:hidden">
                            <div className="w-full max-w-xl">
                                <div className="rounded-[1.5rem] border border-black/[0.08] bg-white/92 p-4 shadow-[0_28px_90px_rgba(0,0,0,0.1)] backdrop-blur-2xl sm:rounded-[2rem] sm:p-7">
                                    <p className="text-[10px] font-bold tracking-[0.16em] text-black/38 uppercase sm:text-[11px]">
                                        Architecture
                                    </p>

                                    <h2 className="mt-3 max-w-[13ch] text-[clamp(2.15rem,9.5vw,3.75rem)] leading-[0.96] font-semibold tracking-[-0.055em] sm:text-5xl">
                                        From source to RTK Fixed.
                                    </h2>

                                    <p className="mt-4 max-w-lg text-sm leading-6 text-black/52 sm:mt-5 sm:text-base sm:leading-7">
                                        Scroll through the four operational
                                        layers. The camera follows the active
                                        component and keeps its RTCM path
                                        visible.
                                    </p>
                                </div>
                                    ...
                                    {NODE_ORDER.map((node) => {
                                        ...
                                        return (
                                            <article
                                                ...
                                                className="flex min-h-[48svh] scroll-mt-28 items-center sm:min-h-[54svh]"
                                            >
                                                <button
                                                    type="button"
                        ...
                        {/*
                         * Desktop/laptop:
                         * toàn bộ tiêu đề + bốn thẻ được pin trong viewport.
                         * Section cao 500svh tạo bốn giai đoạn cuộn.
                         */}
                        <div className="sticky top-0 hidden min-h-[100svh] items-center lg:flex">
                            <div className="mx-auto w-full max-w-[1440px] px-10 pt-24 pb-12">
                                <div className="w-full max-w-[34rem]">
                                    <div className="rounded-[2rem] border border-black/[0.08] bg-white/92 p-8 shadow-[0_28px_90px_rgba(0,0,0,0.1)] backdrop-blur-2xl">
                                        <p className="text-[11px] font-bold tracking-[0.16em] text-black/38 uppercase">
                                            Architecture
                                        </p>

                                        <h2 className="mt-3 max-w-[13ch] text-6xl leading-[0.96] font-semibold tracking-[-0.055em]">
                                            From source to RTK Fixed.
                                        </h2>

                                        <p className="mt-5 max-w-lg text-base leading-7 text-black/52">
                                            The Architecture panel stays pinned
                                            while the camera moves from the
                                            network overview to every
                                            operational layer. After step 04,
                                            the whole panel leaves with the
                                            page.
                                        </p>
                                    </div>
                                        ...
                                        {NODE_ORDER.map((node) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`group grid w-full grid-cols-[3rem_minmax(0,1fr)_auto] items-center gap-4 rounded-[1.4rem] border px-5 py-4 text-left shadow-[0_16px_48px_rgba(0,0,0,0.07)] backdrop-blur-2xl transition focus-visible:ring-2 focus-visible:ring-black/20 focus-visible:outline-none ${
                                                        selected
                                                            ? 'border-black bg-black text-white shadow-[0_24px_70px_rgba(0,0,0,0.2)]'
                                                            : 'border-black/[0.08] bg-white/88 hover:-translate-y-0.5 hover:border-black/14 hover:bg-white'
                                                    }`}
                                                >
                                                    <span
                        ...
                        {/*
                         * Bốn vùng cuộn vô hình.
                         * IntersectionObserver dùng chúng để active từng thẻ.
                         */}
                        <div
                            aria-hidden="true"
                            className="pointer-events-none absolute inset-x-0 top-[70svh] hidden lg:block"
                        >
                            {NODE_ORDER.map((node) => (
                                <div
                                    key={node}
