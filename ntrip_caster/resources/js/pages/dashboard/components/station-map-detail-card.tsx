...
export function StationMapDetailCard({
    ...
    return (
        <aside
            ...
            className={cn(
                'ntrip-glass-panel',
                'pointer-events-auto fixed z-[90] w-80 overflow-visible rounded-2xl transition duration-300 ease-out',
        ...
        >
            ...
            <header className="flex items-start justify-between gap-3 border-b border-ntrip-ink/8 px-4 py-3">
                <div className="min-w-0">
                    <StatusPill status={station.health} />

                    <h2 className="mt-2 truncate text-lg font-semibold tracking-[-0.025em] text-ntrip-ink">
                        {station.name}
                    </h2>
                ...
                <div className="flex shrink-0 items-center gap-1">
                    <span className="grid size-9 place-items-center rounded-2xl bg-ntrip-teal/13 text-ntrip-teal">
            ...
            <div className="grid grid-cols-2 gap-2 p-3">
                <div className="rounded-xl bg-ntrip-cloud/58 p-2.5 shadow-ntrip-inset">
            ...
            <dl className="grid gap-2 border-t border-ntrip-ink/8 px-4 py-3 text-xs">
            ...
            <div className="border-t border-ntrip-ink/8 p-3">
                <Button
                    asChild
                    className="h-9 w-full rounded-xl bg-ntrip-ink text-xs text-ntrip-cloud hover:bg-ntrip-ink/90"
                >
