...
/*
 * Bootstrap identity is used only before the server approves the ESP32.
 * After provisioning, device_id, mountpoint and auth token are read from NVS.
 */
...
inline constexpr char BOOTSTRAP_PROVISIONING_KEY[] =
    "ctuav-real-base-001-development-token";
...
inline constexpr char PROVISIONING_PATH_PREFIX[] =
